...
class RegisterUserViewTests(TestCase):
    ...
    def test_register_successful(self):
        ...
        # Verify email content (HTML template)
        ...
        self.assertIn(user.first_name, mail.outbox[0].body)  # Name appears in HTML body
    ...
    def test_register_email_already_exists(self):
        ...
        """
        User.objects.create_user(email=self.valid_user_data['email'], password="SecureT3st!ng", first_name=self.valid_user_data['first_name'], last_name=self.valid_user_data['last_name'])
